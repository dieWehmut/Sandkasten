...
pub(crate) fn plan(
    ...
    match language.as_str() {
        ...
        "graphviz" => Ok(languages::plan_graphviz(
            job,
            source_dir,
            env,
            entrypoint,
        ...
        "markdown" => Ok(languages::plan_markdown(
            job,
            source_dir,
            env,
            entrypoint,
        ...
        "octave" => Ok(languages::plan_octave(
            job,
            source_dir,
            env,
            entrypoint,
