...
// Polling terminal contract is centralized in state/status.ts:
// JOB_STATUS_SUCCEEDED, JOB_STATUS_COMPILE_FAILED, JOB_STATUS_RUNTIME_FAILED,
// JOB_STATUS_TIME_LIMIT_EXCEEDED, JOB_STATUS_MEMORY_LIMIT_EXCEEDED,
// JOB_STATUS_OUTPUT_LIMIT_EXCEEDED, JOB_STATUS_CANCELED, JOB_STATUS_SYSTEM_ERROR.
export { TERMINAL_STATUSES } from '../state/status';
import { TERMINAL_STATUSES } from '../state/status';
