...
test('every desktop module the main process imports exists', () => {
  ...
  assert.deepEqual(
    imports.slice().sort(),
    ['config-override.mjs', 'distribution.mjs', 'ipc.mjs', 'isolated-runner.mjs', 'local-runner.mjs', 'menu.mjs', 'navigation.mjs', 'terminal-ipc.mjs', 'terminal-profiles.mjs', 'terminal.mjs', 'tray.mjs', 'workspace.mjs'],
  );
