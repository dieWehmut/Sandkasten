...
test('every desktop module the main process imports exists', () => {
  ...
  assert.deepEqual(
    imports.slice().sort(),
    ['config-override.mjs', 'distribution.mjs', 'ipc.mjs', 'isolated-runner.mjs', 'local-runner.mjs', 'menu.mjs', 'navigation.mjs', 'terminal-ipc.mjs', 'terminal-profiles.mjs', 'terminal-pty.mjs', 'terminal.mjs', 'tray-probe.mjs', 'tray.mjs', 'updates.mjs', 'workspace.mjs'],
  );
