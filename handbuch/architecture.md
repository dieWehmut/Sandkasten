...
Sandkasten v1 is a self-hosted code execution system for Go, C, C++, C#, Java, JavaScript, Julia, Kotlin, Lean4, Lua, Python, R, Rust, and TypeScript jobs.
...
The first non-Go runtime contract is single-file source with language-specific default entrypoints: `main.c`, `main.cpp`, `Program.cs`, `Main.java`, `main.js`, `main.jl`, `Main.kt`, `Main.lean`, `main.lua`, `main.py`, `main.R`, `main.rs`, and `main.ts`.
