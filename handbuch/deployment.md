...
- The runner image includes Go plus system toolchains for C, C++, C#, Java, JavaScript, Julia, Kotlin, Lean4, Lua, Python, R, Rust, and TypeScript execution.
...
The full smoke submits source through the HTTP API for `go`, `c`, `cpp`, `csharp`, `java`, `javascript`, `julia`, `kotlin`, `lean4`, `lua`, `python`, `r`, `rust`, and `typescript`.
