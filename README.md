...
Sandkasten is a self-hosted code execution system. The v1 implementation runs Go, Bash/Shell, C, Cangjie, Clojure, C++, C#, Coq, Crystal, Dart, Elixir, F#, Haskell, Java, JavaScript, Julia, Kotlin, Lean4, Lua, Mojo, Nextflow, Nim, Perl, PHP, Prolog, Python, R, Racket, Ruby, Rust, Scala, SQL, Swift, TypeScript, WDL, and Zig jobs:
