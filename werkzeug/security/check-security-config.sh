...
require_file_contains "werkzeug/security/preflight.sh" 'unset LAEUFER_RLIMIT_CPU_SECONDS'
require_file_contains "werkzeug/security/preflight.sh" 'LAEUFER_PIDS_MAX'
require_file_contains "werkzeug/security/preflight.sh" 'memory.swap.max'
