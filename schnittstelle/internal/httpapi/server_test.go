...
func TestRunNewLanguagesFromSourceSubmitDefaultEntrypoints(t *testing.T) {
	tests := []struct {
		...
		{path: "/v1/dot/run", language: "graphviz", entrypoint: "main.dot", source: "digraph G { ok -> done }\n"},
		...
		{path: "/v1/tex/run", language: "latex", entrypoint: "main.tex", source: "\\documentclass{article}\\begin{document}ok\\end{document}\n"},
		{path: "/v1/lua5.4/run", language: "lua", entrypoint: "main.lua", source: `print("ok")`},
		{path: "/v1/md/run", language: "markdown", entrypoint: "main.md", source: "# ok\n\n```mermaid\ngraph TD; A-->B;\n```\n"},
		{path: "/v1/mdx/run", language: "mdx", entrypoint: "main.mdx", source: "# ok\n\n<strong>static</strong>\n"},
		...
		{path: "/v1/typ/run", language: "typst", entrypoint: "main.typ", source: "= ok\n"},
